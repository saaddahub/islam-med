...
export const AppointmentModal: React.FC<AppointmentModalProps> = ({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-2xl bg-[#05091A] text-white rounded-3xl border border-white/15 p-6 sm:p-8 my-8">
        ...
        {isSubmitted ? (
          ...
          <div className="text-center py-10 space-y-6" aria-live="polite">
            <div className="w-16 h-16 rounded-full bg-[#2563EB]/20 text-[#93C5FD] border border-[#2563EB]/40 flex items-center justify-center mx-auto">
            ...
            <button
              type="button"
              onClick={handleReset}
              className="px-8 py-3 rounded-full bg-[#2563EB] text-white font-medium text-xs uppercase tracking-wider hover:bg-[#1D4ED8] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] active:scale-95 transition-[background-color,transform] duration-150 cursor-pointer shadow-md"
            >
              Done
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-3.5 py-2.5 text-base sm:text-sm text-white focus:border-[#2563EB] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB]/60 transition-colors duration-150"
                >
                  {DEPARTMENTS.map((dept) => (
                    <option key={dept.id} value={dept.id} className="bg-[#05091A] text-white">
              ...
              <div className="space-y-1.5">
                ...
                >
                  {DOCTORS.map((doc) => (
                    <option key={doc.id} value={doc.id} className="bg-[#05091A] text-white">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5 text-xs text-[#93C5FD]">
                  ...
                  <input
                    ...
                    className="bg-transparent border-0 text-[#93C5FD] font-mono text-xs focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#2563EB] rounded px-1 cursor-pointer"
                  />
                </div>
              </div>
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
                {availableSlots.map((slot) => (
                  <button
                    ...
                    className={`py-2 px-2 text-xs font-mono rounded-xl border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] transition-[background-color,border-color,transform] duration-150 active:scale-95 cursor-pointer ${
                      timeSlot === slot
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl pl-9 pr-3 py-2.5 text-base sm:text-sm text-white focus:border-[#2563EB] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB]/60 placeholder:text-slate-600"
                  />
                </div>
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-base sm:text-sm text-white focus:border-[#2563EB] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB]/60 placeholder:text-slate-600"
              />
            </div>
            ...
            <div className="pt-2 flex items-center justify-between gap-4 border-t border-white/10">
              ...
              <button
                type="submit"
                className="px-6 py-3 rounded-full bg-[#2563EB] hover:bg-[#1D4ED8] active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] text-white font-medium text-xs uppercase tracking-wider transition-[background-color,transform] duration-150 flex items-center gap-2 cursor-pointer shadow-[0_2px_12px_rgba(37,99,235,0.3)]"
              >
