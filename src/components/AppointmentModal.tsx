...
export const AppointmentModal: React.FC<AppointmentModalProps> = ({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-2xl bg-[#0F2318] text-white rounded-3xl border border-white/15 p-6 sm:p-8 my-8">
        ...
        {isSubmitted ? (
          ...
          <div className="text-center py-10 space-y-6" aria-live="polite">
            <div className="w-16 h-16 rounded-full bg-[#1B4332]/20 text-[#86EFAC] border border-[#1B4332]/40 flex items-center justify-center mx-auto">
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 max-w-md mx-auto text-left text-xs space-y-2 text-slate-300">
              ...
              <div className="flex justify-between border-b border-white/5 pb-1.5">
                ...
                <span className="text-[#86EFAC] font-mono font-bold">{date} at {timeSlot}</span>
              </div>
            ...
            <button
              type="button"
              onClick={handleReset}
              className="px-8 py-3 rounded-full bg-[#1B4332] text-white font-medium text-xs uppercase tracking-wider hover:bg-[#15382A] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1B4332] active:scale-95 transition-[background-color,transform] duration-150 cursor-pointer shadow-md"
            >
              Done
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1 pr-8">
              <div className="flex items-center gap-2 text-[11px] font-mono text-[#86EFAC] uppercase tracking-wider font-semibold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-3.5 py-2.5 text-base sm:text-sm text-white focus:border-[#1B4332] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1B4332]/60 transition-colors duration-150"
                >
                  {DEPARTMENTS.map((dept) => (
                    <option key={dept.id} value={dept.id} className="bg-[#0F2318] text-white">
              ...
              <div className="space-y-1.5">
                ...
                >
                  {DOCTORS.map((doc) => (
                    <option key={doc.id} value={doc.id} className="bg-[#0F2318] text-white">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5 text-xs text-[#86EFAC]">
                  ...
                  <input
                    ...
                    className="bg-transparent border-0 text-[#86EFAC] font-mono text-xs focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#1B4332] rounded px-1 cursor-pointer"
                  />
                </div>
              </div>
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
                {availableSlots.map((slot) => (
                  <button
                    ...
                    className={`py-2 px-2 text-xs font-mono rounded-xl border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1B4332] transition-[background-color,border-color,transform] duration-150 active:scale-95 cursor-pointer ${
                      timeSlot === slot
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl pl-9 pr-3 py-2.5 text-base sm:text-sm text-white focus:border-[#1B4332] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1B4332]/60 placeholder:text-slate-600"
                  />
                </div>
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-base sm:text-sm text-white focus:border-[#1B4332] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1B4332]/60 placeholder:text-slate-600"
              />
            </div>
            ...
            <div className="pt-2 flex items-center justify-between gap-4 border-t border-white/10">
              <div className="flex items-center gap-1.5 text-[11px] text-slate-300">
                <AlertCircle className="w-3.5 h-3.5 text-[#86EFAC]" aria-hidden="true" />
                <span>Zero cancellation fees. Reschedule anytime.</span>
              </div>

              <button
                type="submit"
                className="px-6 py-3 rounded-full bg-[#1B4332] hover:bg-[#15382A] active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1B4332] text-white font-medium text-xs uppercase tracking-wider transition-[background-color,transform] duration-150 flex items-center gap-2 cursor-pointer shadow-[0_2px_12px_rgba(27,67,50,0.3)]"
              >
