...
export const Footer: React.FC<FooterProps> = ({ onOpenAppointment }) => {
  ...
  return (
    <footer className="relative z-20 w-full bg-[#0C1414] text-white border-t border-white/10 pt-20 pb-12 overflow-hidden">
      <motion.div
        ...
        <div className="border-b border-white/10 pb-16 mb-16">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            ...
            <button
              ...
              className="shrink-0 px-8 py-5 rounded-full bg-[#1DBF8A] text-white font-medium text-sm sm:text-base tracking-tight uppercase hover:bg-[#0EA571] active:scale-95 transition-[background-color,transform] duration-150 shadow-[0_4px_20px_rgba(29,191,138,0.35)] flex items-center gap-3 cursor-pointer"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-16 border-b border-white/10 text-xs text-slate-300">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-2 text-white font-medium">
              <ShieldCheck className="w-4 h-4 text-[#A7F3D0]" aria-hidden="true" />
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2.5 font-sans">
              ...
              <div className="flex items-center gap-2">
                <Mail className="w-3.5 h-3.5 text-[#A7F3D0]" aria-hidden="true" />
                <span>care@islammedical.org</span>
              </div>
              <div className="flex items-start gap-2">
                <MapPin className="w-3.5 h-3.5 text-[#A7F3D0] shrink-0 mt-0.5" aria-hidden="true" />
                <span>Sector G-10 Medical Enclave, Islamabad, Pakistan</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="w-3.5 h-3.5 text-[#A7F3D0]" aria-hidden="true" />
