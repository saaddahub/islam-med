...
export const Footer: React.FC<FooterProps> = ({ onOpenAppointment }) => {
  ...
  return (
    <footer className="relative z-20 w-full bg-[#05091A] text-white border-t border-white/10 pt-20 pb-12 overflow-hidden">
      <motion.div
        ...
        <div className="border-b border-white/10 pb-16 mb-16">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            ...
            <button
              ...
              className="shrink-0 px-8 py-5 rounded-full bg-[#2563EB] text-white font-medium text-sm sm:text-base tracking-tight uppercase hover:bg-[#1D4ED8] active:scale-95 transition-[background-color,transform] duration-150 shadow-[0_4px_20px_rgba(37,99,235,0.35)] flex items-center gap-3 cursor-pointer"
            >
