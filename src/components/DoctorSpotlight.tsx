...
export const DoctorSpotlight: React.FC<DoctorSpotlightProps> = ({
  ...
  return (
    <section id="about" className="relative z-20 w-full bg-[#0F2318] text-white py-24 sm:py-36 border-t border-white/10 overflow-hidden">
      
      {/* Background glow accent */}
      <div className="absolute top-1/2 left-1/3 -translate-y-1/2 w-96 h-96 bg-[#1B4332]/10 rounded-full blur-3xl pointer-events-none" />
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6 sm:gap-8">
            ...
            <div className="relative shrink-0">
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-2 border-[#1B4332]">
                <img
                  src={doctor.image}
                  alt=""
              ...
              <span className="absolute bottom-0 right-0 w-5 h-5 rounded-full bg-[#0F2318] flex items-center justify-center border border-white/20" title="Clinical Chief on active roster">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-3">
                <span className="px-3 py-1 rounded-full bg-white/10 text-[11px] font-mono tracking-widest text-[#86EFAC] uppercase border border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pt-4 border-t border-white/10">
            ...
            <div className="md:col-span-4 space-y-3">
              <div className="inline-block px-3 py-1 rounded-full bg-[#1B4332]/20 text-[#86EFAC] text-xs font-medium uppercase tracking-wider border border-[#1B4332]/30">
                MEET {doctor.name}
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 pt-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 rounded-full bg-[#1B4332] hover:bg-[#15382A] active:scale-95 text-white text-xs font-medium uppercase tracking-wider transition-[background-color,transform] duration-150 shadow-[0_2px_12px_rgba(27,67,50,0.25)] flex items-center gap-1.5 cursor-pointer"
                  >
