...
export const HowItWorksSticky: React.FC<HowItWorksStickyProps> = ({ onOpenAppointment }) => {
  const getStepIcon = (index: number) => {
    switch (index) {
      case 0:
        return <UserCheck className="w-5 h-5 text-[#1D4ED8]" aria-hidden="true" />;
      case 1:
        return <CalendarDays className="w-5 h-5 text-[#DC2626]" aria-hidden="true" />;
      case 2:
        return <HeartPulse className="w-5 h-5 text-[#1D4ED8]" aria-hidden="true" />;
      case 3:
      default:
  ...
  return (
    <section id="how-it-works" className="relative z-20 w-full bg-[#FAF8F5] text-[#0F172A] py-24 sm:py-32 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28 space-y-8">
            ...
            <h2 className="font-serif-display text-5xl sm:text-6xl md:text-7xl text-[#0F172A] leading-[0.95]">
              How it{' '}
            ...
            <div className="p-6 rounded-3xl bg-[#0D1B2A] text-white space-y-4 border border-white/10">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex-1 py-3 px-5 rounded-full bg-[#1D4ED8] text-white font-medium text-xs uppercase tracking-wider hover:bg-[#1E40AF] active:scale-95 transition-[background-color,transform] duration-150 flex items-center justify-center gap-2 shadow-[0_2px_12px_rgba(29,78,216,0.25)] cursor-pointer"
                >
                ...
                <button
                  type="button"
                  onClick={onOpenAppointment}
                  className="w-11 h-11 rounded-full flex items-center justify-center bg-white/10 text-white hover:bg-white hover:text-[#0D1B2A] active:scale-90 transition-[background-color,color,transform] duration-150 shrink-0 cursor-pointer"
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <span className="font-mono text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full bg-white/90 backdrop-blur-md text-[#0F172A] border border-black/5 shadow-xs">
                      Step {step.step}
                    </span>
                  ...
                  <div className="space-y-3">
                    <h3 className="font-anton text-2xl sm:text-3xl md:text-4xl uppercase tracking-tight text-[#0F172A]">
                      {step.title}
                    </h3>
                  ...
                  <div className="mt-6 pt-4 border-t border-black/10 flex items-center gap-2 text-xs font-sans text-slate-700 font-medium">
                    <CheckCircle2 className="w-4 h-4 text-[#1D4ED8] shrink-0" aria-hidden="true" />
