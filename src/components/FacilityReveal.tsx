...
export const FacilityReveal: React.FC<FacilityRevealProps> = () => {
  ...
  return (
    <section
      id="facilities"
      ref={sectionRef}
      className="relative z-20 w-full bg-[#0C1414] text-white py-24 sm:py-32 overflow-hidden border-t border-white/10"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/10 pb-8 mb-12 sm:mb-16">
          <div className="space-y-4 max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/10 text-xs font-mono text-[#A7F3D0] uppercase tracking-wider">
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                  <div className="space-y-1">
                    <span className="text-[11px] font-mono tracking-widest text-[#A7F3D0] uppercase">
                      {currentFeature.tag}
                    </span>
            ...
            return (
              <motion.button
                ...
                className={`text-left p-6 rounded-2xl transition-[background-color,border-color,transform] duration-200 cursor-pointer active:scale-[0.98] border ${
                  isSelected
                    ? 'bg-white/10 border-[#1DBF8A] ring-1 ring-[#1DBF8A]/40'
