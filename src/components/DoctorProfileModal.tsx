...
export const DoctorProfileModal: React.FC<DoctorProfileModalProps> = ({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-3xl bg-[#0D1B2A] text-white rounded-3xl border border-white/15 overflow-hidden my-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12">
          ...
          <div className="md:col-span-5 relative bg-slate-900 min-h-[280px] md:min-h-full">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0D1B2A] via-transparent to-transparent md:hidden" />
          ...
          <div className="md:col-span-7 p-6 sm:p-8 space-y-6">
            ...
            <div className="pt-4 flex items-center justify-between gap-4 border-t border-white/10">
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-full bg-[#1D4ED8] hover:bg-[#1E40AF] active:scale-95 text-white font-medium text-xs uppercase tracking-wider transition-[background-color,transform] duration-150 shadow-[0_2px_12px_rgba(29,78,216,0.3)] flex items-center gap-2 cursor-pointer"
              >
