    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      >
        ...
        <path
          ...
          fill={isDarkBg ? "#A7F3D0" : "#1DBF8A"}
        />
        {/* Red Head Dot */}
        <circle cx="60" cy="26" r="3.5" fill="#E11D2A" />

        {/* IMC Monogram */}
        <g fill={isDarkBg ? "#FFFFFF" : "#1DBF8A"}>
      ...
      <div className="flex flex-col">
        <span
          className={`font-anton uppercase tracking-wider text-xl sm:text-2xl leading-none ${
            isDarkBg ? 'text-white' : 'text-[#1DBF8A]'
          }`}
        >
          ISLAM
        </span>
